...
--ALTERAR COD ASIG PARA QUE SEA UN NUMERO
ALTER TABLE ASIGNATURA DROP CONSTRAINT PK_ASIGNATURA;
ALTER TABLE ASIGNATURA DROP COLUMN CODASIG;
ALTER TABLE ASIGNATURA ADD CODASIG NUMBER(3);
ALTER TABLE ASIGNATURA ADD CONSTRAINT PK_ASIGNATURA PRIMARY KEY (CODASIG);

ALTER TABLE MATRICULA DROP CONSTRAINT FK_MATRICULA_CODASIG;
ALTER TABLE MATRICULA DROP CONSTRAINT PK_MATRICULA;
ALTER TABLE MATRICULA DROP COLUMN CODASIG_ASIGNATURA;
ALTER TABLE MATRICULA ADD CODASIG_ASIGNATURA NUMBER(3);
ALTER TABLE MATRICULA ADD CONSTRAINT FK_MATRICULA_CODASIG FOREIGN KEY (CODASIG_ASIGNATURA) REFERENCES ASIGNATURA(CODASIG);
ALTER TABLE MATRICULA ADD CONSTRAINT PK_MATRICULA PRIMARY KEY (DNI_ALUMNO,CODASIG_ASIGNATURA);
...
--CREAR SECUENCIAS
CREATE SEQUENCE SECUENCIAMATRICULA START WITH 1 INCREMENT BY 1 MAXVALUE 999 NOCYCLE;
CREATE SEQUENCE SECUENCIAASIGNATURA START WITH 1 INCREMENT BY 1 MAXVALUE 999 NOCYCLE;

--INSERTAR DATOS CON SECUENCIAS
INSERT INTO ASIGNATURA(CODASIG,NOMBRE,NUMHORAS,DNI_PROFESOR,CODCICLO_CICLOFORM) VALUES(SECUENCIAMATRICULA.NEXTVAL,'Empresa',128,'44103779F',1565);
INSERT INTO ASIGNATURA(CODASIG,NOMBRE,NUMHORAS,DNI_PROFESOR,CODCICLO_CICLOFORM) VALUES(SECUENCIAMATRICULA.NEXTVAL,'Informática Industrial',269,'44103779F',1565);
INSERT INTO ASIGNATURA(CODASIG,NOMBRE,NUMHORAS,DNI_PROFESOR,CODCICLO_CICLOFORM) VALUES(SECUENCIAMATRICULA.NEXTVAL,'Aplicaciones Web',200,'89621477A',2598);
INSERT INTO ASIGNATURA(CODASIG,NOMBRE,NUMHORAS,DNI_PROFESOR,CODCICLO_CICLOFORM) VALUES(SECUENCIAMATRICULA.NEXTVAL,'Bases de datos',170,'89621477A',1489);
INSERT INTO ASIGNATURA(CODASIG,NOMBRE,NUMHORAS,DNI_PROFESOR,CODCICLO_CICLOFORM) VALUES(SECUENCIAMATRICULA.NEXTVAL,'Programación',225,'89621477A',2598);

INSERT INTO MATRICULA(DNI_ALUMNO,CODASIG_ASIGNATURA) VALUES('71654896M',SECUENCIAASIGNATURA.NEXTVAL);
INSERT INTO MATRICULA(DNI_ALUMNO,CODASIG_ASIGNATURA) VALUES('11526987G',SECUENCIAASIGNATURA.NEXTVAL);
INSERT INTO MATRICULA(DNI_ALUMNO,CODASIG_ASIGNATURA) VALUES('45986321N',SECUENCIAASIGNATURA.NEXTVAL);
INSERT INTO MATRICULA(DNI_ALUMNO,CODASIG_ASIGNATURA) VALUES('71056984D',SECUENCIAASIGNATURA.NEXTVAL);
INSERT INTO MATRICULA(DNI_ALUMNO,CODASIG_ASIGNATURA) VALUES('71654896M',SECUENCIAASIGNATURA.NEXTVAL);

--PARA REDUCIR LA SECUENCIA POR SI NOS HEMOS EQUIVOCADO
ALTER SEQUENCE SECUENCIAASIGNATURA INCREMENT BY -20; -- POR EJEMPLO REDUCIRIA -20 LA SIGUIENTE VEZ QUE USARAMOS LA SECUENCIA
-- LUEGO HACEMOS EL INSERT O SELECT SECUENCIAASIGNATURA.NEXTVAL FROM DUAL PARA CHECKEAR, HAY QUE TENER EN CUENTA QUE SI HACEMOS SELECT YA ESTARIAMOS PASANDO AL 1 ASI QUE EL SIGUIENTE INSERT SERIA -19
SELECT SECUENCIAASIGNATURA.CURRVAL FROM DUAL;
ALTER SEQUENCE SECUENCIAASIGNATURA INCREMENT BY 1;   -- UNA VEZ YA SE REDUCIÓ A 1 LA SECUENCIA VOLVEMOS A PONER EL INCREMENTO EN 1, SINO HARIA -19 Y -19 SALIENDOSE DE RANGO

-- IMAGINEMOS QUE ESTAMOS EN VALOR 21, PUES SETEAMOS EL INCREMENTO A -20 Y HACEMOS UN INSERT Y SALTARÁ AL 1, LUEGO CAMBIAMOS EL INCREMENTO A +1 Y EL SIGUIENTE INSERT SERÁ 2
-- ES DECIR, O HACEMOS DIRECTAMENTE EL INSERT O DESPUES DEL SELECT HACEMOS CURRVAL EN EL SELECT

-- es DECIR
-- restamos, luego hacemos el select con nextval de dual, hacemos el currval y luego cambiamos a que incremente uno a uno