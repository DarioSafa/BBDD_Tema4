...
-- DATOSPERSONALES
ALTER TABLE DATOSPERSONALES ADD CONSTRAINT FK_CODTIPO_DATOSPERSONALES FOREIGN KEY(CODTIPO) REFERENCES TIPODP(CODTIPO) ON DELETE CASCADE;
ALTER TABLE DATOSPERSONALES MODIFY TELEFONO NOT NULL;
ALTER TABLE DATOSPERSONALES MODIFY CORREO NOT NULL;


-- DIRECTOR
ALTER TABLE DIRECTOR ADD ANIOS NUMBER(3);

-- COMERCIAL
ALTER TABLE COMERCIAL DROP COLUMN COMISION;

-- OFICINA
ALTER TABLE COMERCIAL ADD COMISION NUMBER(3);
...
ALTER TABLE LIBRO ADD CONSTRAINT FK_CODTIPO_TEMATICA FOREIGN KEY(CODTEM) REFERENCES TMEATICALIBRO(CODTEM) ON DELETE CASCADE;
